...
namespace JMF.CodeLibrary.Common
{
     ...
     * per process
     */
    //copy from https://github.com/dunitian/snowflake-net/tree/master/Snowflake.Net.Core
    ...
    public class IdWorker
    {
        ...
        public IdWorker(long workerId, long datacenterId, long sequence = 0L)
        {
            ...
            {
                throw new ArgumentException(string.Format("datacenterId Id 必须大于0，且不能大于MaxWorkerId： {0}", MaxDatacenterId));
            }
